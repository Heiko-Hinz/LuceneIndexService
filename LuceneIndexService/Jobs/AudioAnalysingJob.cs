...
{
    public class AudioAnalysingJob : BaseAnalysingJob
    {
        ...
        public AudioAnalysingJob() : base()
        {
            Init();
        }
        public AudioAnalysingJob(ServiceIndex index, Web web, Settings.FileType fileSettings, string path, Uri url, List<string> folderAuthorizedRoles) : 
        ...
        private void Init()
        {
            ...
            DocumentType = DocumentTypes.Audio;
            Description = "Analysiert eine Audio-Datei und fügt sie dem Index hinzu.";
