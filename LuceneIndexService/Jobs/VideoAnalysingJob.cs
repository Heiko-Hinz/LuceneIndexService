...
{
    public class VideoAnalysingJob : BaseAnalysingJob
    {
        ...
        public VideoAnalysingJob() : base()
        {
            Init();
        }
        public VideoAnalysingJob(ServiceIndex index, Web web, Settings.FileType fileSettings, string path, Uri url, List<string> folderAuthorizedRoles) : 
        ...
        private void Init()
        {
            ...
            Description = "Analysiert eine Video-Datei und fügt sie dem Index hinzu.";
